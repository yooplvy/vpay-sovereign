...
async function main() {
  ...
  console.log(`🚀 DEPLOYING FINAL AUDIT STACK with ${deployer.address}`);
  ...
  const oracle = await OracleTriad.deploy(mockCl.address, "0x0000000000000000000000000000000000000000", mockBand.address);
  ...
  console.log("\n═══════════════════════════════════");
  console.log("  FINAL AUDIT STACK DEPLOYED");
  console.log("═══════════════════════════════════");
